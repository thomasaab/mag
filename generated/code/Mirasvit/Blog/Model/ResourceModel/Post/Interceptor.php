...
class Interceptor extends \Mirasvit\Blog\Model\ResourceModel\Post implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Mirasvit\Blog\Model\Config $config, \Mirasvit\Blog\Model\TagFactory $tagFactory, \Magento\Framework\Filter\FilterManager $filter, \Magento\Eav\Model\Entity\Context $context, $data = [])
    {
        $this->___init();
