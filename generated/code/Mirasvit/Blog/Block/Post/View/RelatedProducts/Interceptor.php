<?php
namespace Mirasvit\Blog\Block\Post\View\RelatedProducts;

/**
 * Interceptor class for @see \Mirasvit\Blog\Block\Post\View\RelatedProducts
 */
class Interceptor extends \Mirasvit\Blog\Block\Post\View\RelatedProducts implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentPost');
        if (!$pluginInfo) {
            return parent::getCurrentPost();
        } else {
            return $this->___callPlugins('getCurrentPost', func_get_args(), $pluginInfo);
        }
    }
